...
initial worksheet that describes how to use the spreadsheet. There three distributions of the spreadsheet are listed below. Click on one of the three hyperlinks below to download it. To edit and save your 	data, your version of Excel on your computer may require you to click on "Enable Editing" if it says "Protected View" at the top of the screen.
